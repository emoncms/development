...
<script language="javascript" type="text/javascript" src="<?php echo $path; ?>Modules/app/graph.js"></script>
...
<script>
    ...
    var config = {};
    $.ajax({ url: path+"app/get.json", dataType: 'json', async: false, success: function(data) {config = data;} });
...
;
    ...
    $("#configsave").click(function(){
        ...
        $.ajax({ url: path+"app/set.json", data: "data="+JSON.stringify(config), async: false, success: function(data){} });
    });
