...
<script type="text/javascript" src="<?php echo $path; ?>Modules/app/roundedrect.js"></script>

<script type="text/javascript" src="<?php echo $path; ?>Modules/app/myheatpump.js"></script>
