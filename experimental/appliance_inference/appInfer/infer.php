...
<html>
 <head>
    ...
    <title>Appliance inference</title>
 ...
 <div id="bound">
   ...
   <div id="box">
     <div id="topd">
       <div id="title">Application inference</div> 
       <div id="menu">
     ...
     <div id="maintext">
 <h3>Appliance kWh breakdown:</h3>
 <p>View event log here:  <A href="eventlog.php">Event Log</A></p>
 <p>View appliance types:  <A href="loadtype.php">Appliance types</A></p>
     <?php
     include 'DB.php';
